          ...
          - generic [ref=e52]:
            - generic [ref=e53]:
              ...
              - textbox "Full Name" [ref=e54]:
                ...
                - text: Combo Tester 172
            - generic [ref=e55]:
              - text: Email Address
              - textbox "Email Address" [ref=e56]:
                - /placeholder: you@example.com
                - text: combo-172-1771688128258@example.com
            - generic [ref=e57]:
  ...
  - generic [ref=e73]:
    - generic [ref=e74]:
      ...
      - generic [ref=e77]:
        ...
        - paragraph [ref=e79]: We use cookies to enhance your browsing experience, serve personalized content, and analyze our traffic. By clicking "Accept All", you consent to our use of cookies.
    - generic [ref=e80]:
      - button "Customize" [ref=e81] [cursor=pointer]
      - button "Reject All" [ref=e82] [cursor=pointer]
      - button "Accept All" [ref=e83] [cursor=pointer]
```