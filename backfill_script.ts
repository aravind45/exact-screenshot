...
fs.writeFileSync('src/config/settlementPhases.tmp.ts', content);
fs.renameSync('src/config/settlementPhases.tmp.ts', 'src/config/settlementPhases.ts');
console.log('Successfully updated settlementPhases.ts organically');
