...
export interface NJFieldDefinition {
    label: string;
    source: FieldSource;
    path?: string;
    type: FieldType;
...
export type NJFormFieldMap = Record<string, NJFieldDefinition>;

const NJ_HEADER_FIELDS: NJFormFieldMap = {
    petitionerName: {
...
export const NJ1_FIELD_REGISTRY: NJFormFieldMap = {
    ...NJ_HEADER_FIELDS,
    decedentResidence: {
...
export const NJ2_FIELD_REGISTRY: NJFormFieldMap = {
    ...NJ_HEADER_FIELDS,
};

export const NJ_FORM_REGISTRY: Record<string, NJFormFieldMap> = {
    'NJ-1': NJ1_FIELD_REGISTRY,
    'NJ-2': NJ2_FIELD_REGISTRY,
};

export type NJFormId = keyof typeof NJ_FORM_REGISTRY;

export const NJ_FORM_TITLES: Record<NJFormId, string> = {
    'NJ-1': 'Application for Probate',
    'NJ-2': 'Authorization to Accept Service of Process',
};

export function validateNJFormData(
    formId: NJFormId,
