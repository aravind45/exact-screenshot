...
export async function listRoadmapVersions(settlementTypeCode?: string) {
...
export async function createRoadmapVersion(data: any, userId?: string) {
  const rows = await queryRows(`
...
export async function publishRoadmapVersion(id: string, userId?: string) {
...
export async function deleteRoadmapVersion(id: string, userId?: string) {
