...
export class DistributionService {
     ...
     */
    static async checkReadiness(estateId: string): Promise<DistributionReadiness> {
     ...
     */
    static async logEvent(estateId: string, userId: string, eventType: string, customNotes?: string) {
