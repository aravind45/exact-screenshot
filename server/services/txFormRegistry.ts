...
export interface TXFieldDefinition {
    label: string;
    source: FieldSource;
    path?: string;
    type: FieldType;
...
export type TXFormFieldMap = Record<string, TXFieldDefinition>;

const TX_HEADER_FIELDS: TXFormFieldMap = {
    applicantName: {
...
export const TX1_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
    willDate: {
...
export const TX2_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
    administratorName: {
...
export const TX3_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
    independentAdministration: {
...
export const TX4_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
    orderDate: {
        label: 'Order Date',
        source: 'computed',
...
export const TX5_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
    executorName: {
        label: 'Executor Name',
        source: 'computed',
...
export const TX6_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
    administratorName: {
...
export const TX7_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
    inventoryDate: {
...
// TX-8: Annual Account
export const TX8_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
    accountPeriodStart: {
...
export const TX9_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
...
// TX-10: Final Account
export const TX10_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
    accountPeriodStart: {
        label: 'Account Period Start',
        source: 'override',
...
export const TX11_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
    smallEstateValue: {
...
export const TX12_FIELD_REGISTRY: TXFormFieldMap = {
    ...TX_HEADER_FIELDS,
    willDate: {
        label: 'Will Execution Date',
        source: 'estate',
...
export const TX_FORM_REGISTRY: Record<string, TXFormFieldMap> = {
...
export type TXFormId = keyof typeof TX_FORM_REGISTRY;

export const TX_FORM_TITLES: Record<TXFormId, string> = {
    'TX-1': 'Application for Probate of Will',
    'TX-2': 'Application for Letters of Administration',
    'TX-3': 'Application for Independent Administration',
    'TX-4': 'Order Admitting Will to Probate',
...
export function validateTXFormData(
    formId: TXFormId,
