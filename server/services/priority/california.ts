...
export const CA_COUNTY_FEES: Record<string, { filingFee: number; firstPetitionFee: number; citation?: string; notes?: string }> = {
    "Los Angeles": {
        filingFee: 435,
...
export const CA_BRANCHING_CONFIG = {
    ...
    determinePath: (params: {
        ...
        daysSinceDeath: number;
        hasTrust: boolean;
        trustTransferIssues: boolean;
    }): { path: "small_estate" | "spousal" | "heggstad" | "formal_probate"; reason: string } => {
