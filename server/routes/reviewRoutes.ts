 ...
 */
router.get('/advisor/:advisorId', async (req: any, res: Response) => {
    try {
 ...
 */
router.get('/advisor/:advisorId/stats', async (req: any, res: Response) => {
    try {
 ...
 */
router.get('/my-reviews', authenticate, async (req: any, res: Response) => {
    try {
