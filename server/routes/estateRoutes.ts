...
router.get("/:estateId", authenticate, requireEstateAccess, async (req: any, res: Response) => {
    try {
...
router.put("/:estateId", authenticate, requireEstateAccess, async (req: any, res: Response) => {
    try {
        const userId = req.user.id;
