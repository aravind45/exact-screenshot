...
const ROLE_HIERARCHY: Record<EstateRole, number> = {
    'OWNER': 40,
    'CO_EXECUTOR': 30,
    'ATTORNEY': 20,
    'VIEWER': 10
 ...
 */
export const checkEstateRole = async (userId: string, estateId: string, requiredRole: EstateRole): Promise<boolean> => {
    ...
    // 3. Compare Levels
    const userLevel = ROLE_HIERARCHY[grant.role as EstateRole] || 0;
 ...
 */
export const requireRole = (requiredRole: EstateRole) => {
