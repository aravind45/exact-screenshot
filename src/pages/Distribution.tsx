            ...
            <main className="flex-1 ml-64 p-8">
                <div className="max-w-4xl mx-auto space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-black text-slate-900 tracking-tight">Final Distribution</h1>
                    ...
                    <Card className="border-2 border-dashed border-slate-200 bg-slate-50/50">
                        <CardContent className="flex flex-col items-center justify-center py-20 text-center">
                            ...
                            <CardTitle className="text-xl font-bold text-slate-900">Distribution Tracking Coming Soon</CardTitle>
                            <CardDescription className="max-w-md mt-2 text-slate-500">
                                Track the physical and electronic transfer of assets to heirs.
                                Ensure all heirs sign their receipts to protect the executor.
                            </CardDescription>
                            <Button
