...
const IntegrityDashboard = lazy(() => import("./pages/admin/IntegrityDashboard"));
      ...
      <WorkflowProvider>
        <Suspense fallback={
          ...
          <Routes>
            ...
            <Route path="/admin/integrity" element={<ProtectedRoute><RoleRoute allowedRoles={['ADMIN']}><IntegrityDashboard /></RoleRoute></ProtectedRoute>} />
