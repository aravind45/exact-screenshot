...
if (!isStripeConfigured) {
    console.warn("Stripe publishable key is missing or placeholder. Set VITE_STRIPE_PUBLISHABLE_KEY, NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY, or STRIPE_PUBLISHABLE_KEY.");
}
