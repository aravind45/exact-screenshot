...
const FreeRoadmap = lazy(() => import("./pages/FreeRoadmap"));
const EstateStatus = lazy(() => import("./pages/EstateStatus"));
      ...
      <WorkflowProvider>
        <Suspense fallback={
          ...
          <Routes>
            ...
            <Route path="/free-roadmap" element={<FreeRoadmap />} />
            <Route path="/estate-status/:estateId/:token" element={<EstateStatus />} />
