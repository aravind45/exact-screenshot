...
import { discoverRelatedAssets } from "./ai.js";
...
export class AgentService {
     ...
     */
    static async runWatchdogScan(estateId) {
     ...
     */
    static async runConciergeEnrichment(assetId) {
     ...
     */
    static async runDetectiveDiscovery(text, imageBase64 = "") {
