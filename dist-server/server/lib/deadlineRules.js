...
// ─────────────────────────────────────────────────────────────────────────────
export const UNIVERSAL_DEADLINES = [
    {
        id: "FINAL_1040",
        title: "File Decedent's Final Income Tax Return (Form 1040)",
        description: "The executor must file the decedent's final federal income tax return covering Jan 1 of the year of death through the date of death.",
    ...
    },
    {
        ...
        description: "Apply for an EIN for the estate to open an estate bank account, receive estate income, and file estate tax returns.",
...
// ─────────────────────────────────────────────────────────────────────────────
export const ESTATE_TAX_DEADLINES = [
    {
        id: "ESTATE_TAX_706",
        title: "File Federal Estate Tax Return (Form 706)",
        description: "Required if the gross estate exceeds the federal exemption ($13.61M in 2024). File within 9 months of date of death.",
    ...
    },
    {
        ...
        description: "Surviving spouse may elect to use the decedent's unused estate tax exclusion (DSUE). Must file Form 706 even if no tax is owed. Extended to 5 years under Rev. Proc. 2022-32.",
...
// ─────────────────────────────────────────────────────────────────────────────
export const PROBATE_DEADLINES = [
    {
        id: "FILE_PETITION",
        title: "File Petition for Probate",
        description: "File the petition to open probate with the appropriate probate court. While there is generally no absolute statutory deadline, delay beyond 30 days risks asset dissipation and creditor priority disputes.",
    ...
    },
    {
        ...
        description: "Publish legal notice to creditors in a county newspaper of general circulation. Required to start the creditor claim period clock.",
    ...
    },
    {
        ...
        description: "The deadline by which creditors must file claims against the estate. Distributing assets before this date creates personal liability for the executor.",
    ...
    },
    {
        ...
        description: "Complete inventory of all probate assets with appraised fair market values as of date of death. Required for court accounting and estate tax purposes.",
    ...
    },
    {
        ...
        description: "Formal written notice must be sent to all named beneficiaries and heirs-at-law informing them of the estate proceeding.",
    ...
    },
    {
        ...
        description: "Required if the estate has gross income of $600 or more during administration. Due April 15 of the following year (or fiscal year-end + 3.5 months).",
...
// ─────────────────────────────────────────────────────────────────────────────
export const SMALL_ESTATE_DEADLINES = [
    {
        id: "SMALL_ESTATE_WAITING_PERIOD",
        title: "Small Estate Waiting Period Expires",
        description: "Most states require a waiting period after death before a small estate affidavit may be used. After this date, the affidavit can be presented to institutions.",
...
// ─────────────────────────────────────────────────────────────────────────────
export const FL_SUMMARY_DEADLINES = [
    {
        id: "FL_SUMMARY_PETITION",
        title: "File Petition for Summary Administration",
        description: "File the Petition for Summary Administration with the circuit court. No formal administration; court issues Order of Summary Administration directly.",
    ...
    },
    {
        ...
        description: "Under FL Stat. §733.710, no proceeding may be commenced against the estate more than 2 years after the decedent's death regardless of notice. This is the ultimate creditor bar.",
...
// ─────────────────────────────────────────────────────────────────────────────
export const NY_VOLUNTARY_DEADLINES = [
    {
        id: "NY_VOLUNTARY_FILING",
        title: "File Affidavit of Voluntary Administration (SCPA 1310)",
        description: "File with the Surrogate's Court. No formal appointment; voluntary administrator has limited powers. Estate must not exceed $50,000 in personal property.",
    ...
    },
    {
        ...
        description: "Under voluntary administration, creditors have 7 months from issuance of Letters or appointment to file claims.",
...
// ─────────────────────────────────────────────────────────────────────────────
export const TX_MUNIMENT_DEADLINES = [
    {
        id: "TX_MUNIMENT_FILING",
        title: "File Application for Muniment of Title",
        description: "Must be filed within 4 years of death. Used when decedent had a will, estate has no debts, and only property transfers are needed — no executor is appointed.",
    ...
    },
    {
        ...
        description: "After the court approves the Muniment of Title, record the certified copy in the county deed records of each county where real property is located.",
...
// ─────────────────────────────────────────────────────────────────────────────
export const TRUST_ADMIN_DEADLINES = [
    {
        id: "TRUST_BENEFICIARY_NOTICE",
        title: "Send Notice to Trust Beneficiaries",
        description: "The successor trustee must notify all qualified beneficiaries of the trust's existence, right to request a copy, and identity of the trustee. Required in UTC states within 60 days of trust becoming irrevocable.",
    ...
    },
    {
        ...
        description: "Successor trustee must identify, inventory, and safeguard all trust assets within 30-60 days of assuming duties.",
    ...
    },
    {
        ...
        description: "Some states allow trustees of revocable trusts to publish a creditor notice to shorten the claim period. Strongly recommended to limit trustee liability.",
    ...
    },
    {
        ...
        description: "After publishing notice to creditors of the trust, the claim period begins. After expiration, distributions may proceed.",
    ...
    },
    {
        ...
        description: "The trustee must provide a trust accounting to all qualified beneficiaries at least annually under the UTC and most state trust codes.",
...
// SPOUSAL PETITION
// ─────────────────────────────────────────────────────────────────────────────
export const SPOUSAL_PETITION_DEADLINES = [
    {
        id: "SPOUSAL_PETITION_FILE",
        title: "File Spousal Property Petition (DE-221 / State Equivalent)",
        description: "The surviving spouse may file to confirm community/quasi-community property without full probate. File promptly to avoid delays in asset access.",
    ...
    },
    {
        ...
        description: "File Form 706 to elect DSUE portability so the surviving spouse can use the deceased spouse's unused estate tax exclusion. Typically 9 months from DOD (extended to 5 years under Rev. Proc. 2022-32 for late elections).",
        legalBasis: "IRC §2010(c)(5)(A); Rev. Proc. 2022-32",
        anchorType: "DOD",
        offsetDays: 274,
        warningDays: 60,
...
// ANCILLARY PROBATE
// ─────────────────────────────────────────────────────────────────────────────
export const ANCILLARY_DEADLINES = [
    {
        id: "ANCILLARY_FILE",
        title: "File Ancillary Probate in Secondary State",
        description: "After receiving certified copies of Letters from the domiciliary (home) state, file ancillary probate in each state where real property is located.",
    ...
    },
    {
        ...
        description: "Creditor claim period runs independently in each ancillary state based on that state's rules.",
...
// ─────────────────────────────────────────────────────────────────────────────
export const ALL_DEADLINE_RULES = [
    ...UNIVERSAL_DEADLINES,
 ...
 */
export function getRulesForTrack(authorityType) {
    return ALL_DEADLINE_RULES.filter((rule) => rule.tracks.length === 0 || rule.tracks.includes(authorityType));
}
/**
 * For a given rule and state, returns the effective offsetDays and legalBasis.
 */
export function resolveStateOverride(rule, stateCode) {
