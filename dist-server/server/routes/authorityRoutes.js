...
import { requireAuthorityStatus, getEstateGateStatus } from "../middleware/authorityGating.js";
 ...
 * @access Private
 */
router.get("/estates/:estateId/gates", requireEstateAccess, async (req, res) => {
    try {
 ...
 * @access Private
 */
router.get("/estates/:estateId/gates/resolution", requireEstateAccess, async (req, res) => {
    try {
        const { estateId } = req.params;
 ...
 * @access Private
 */
router.get("/estates/:estateId/authority/summary", requireEstateAccess, async (req, res) => {
    try {
        const { estateId } = req.params;
...
router.post("/estates/:estateId/operations/check", requireEstateAccess, async (req, res) => {
    try {
        const { estateId } = req.params;
 ...
 * @access Private
 */
router.get("/estates/:estateId/operations/available", requireEstateAccess, async (req, res) => {
    try {
        const { estateId } = req.params;
 ...
 * @access Private
 */
router.post("/estates/:estateId/operations/:operation/check", requireEstateAccess, async (req, res) => {
    try {
 ...
 * @access Private
 */
router.get("/estates/:estateId/authority/upgrade-options", requireEstateAccess, async (req, res) => {
    try {
        const { estateId } = req.params;
 ...
 * @access Private
 */
router.post("/estates/:estateId/gates/:gate/verify", requireEstateAccess, async (req, res) => {
    try {
        ...
        await EstateGatingService.logGateAccess(estateId, userId, `verify:${gate}`, [gate], gateResult.isOpen, { ip: req.ip, userAgent: req.headers["user-agent"] });
        res.json({
            estateId,
            gate,
 ...
 * @access Private
 */
router.get("/authority/gate-definitions", (req, res) => {
 ...
 * @access Private
 */
router.get("/authority/enforcement-matrix", (req, res) => {
...
router.post("/estates/:estateId/assets/collect", requireEstateAccess, requireAuthorityStatus({
...
router.post("/estates/:estateId/distributions/execute", requireEstateAccess, requireAuthorityStatus({
...
router.post("/estates/:estateId/realestate/sell", requireEstateAccess, requireAuthorityStatus({
