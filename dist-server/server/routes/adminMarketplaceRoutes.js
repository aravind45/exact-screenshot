...
router.post("/payouts/release-due", async (req, res) => {
    try {
...
router.post("/advisors/:id/approve", async (req, res) => {
    try {
...
router.post("/advisors/:id/reject", async (req, res) => {
    try {
...
router.post("/advisors/:id/pause", async (req, res) => {
    try {
...
router.post("/advisors/:id/unpause", async (req, res) => {
    try {
...
router.post("/disputes/:id/resolve", async (req, res) => {
    try {
        ...
        const result = await AdvisorMarketplaceService.adminResolveDispute(req.user.id, req.params.id, refundType, { resolution, refundAmount });
        res.json(result);
    }
    catch (error) {
        if (error instanceof z.ZodError)
