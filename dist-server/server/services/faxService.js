...
export const FaxService = {
    async sendFax(payload) {
        ...
        try {
            ...
            if (!progData.success)
                throw new Error("Failed to create fax program");
    ...
    async logCommunication(userId, assetId, faxNumber, faxId, documentType, subject, isSimulated = false) {
