...
export const RiskService = {
     ...
     */
    async assessEstateRisk(estateId) {
        ...
        const unpaidHighPriorityClaims = liabilities.filter(l => l.status !== 'PAID' && highPriorityClasses.includes(l.priorityClass)).length;
     ...
     */
    async validatePayment(estateId, liabilityId) {
