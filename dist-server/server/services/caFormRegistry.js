...
export const DE111_FIELD_REGISTRY = {
    ...CA_HEADER_FIELDS,
    checkProbateOfWill: {
...
export const DE160_FIELD_REGISTRY = {
    ...CA_HEADER_FIELDS,
    inventoryType: {
...
export const DE310_FIELD_REGISTRY = {
    ...CA_HEADER_FIELDS,
    totalInventoryValue: {
        label: 'Total Inventory Value ($)',
        source: 'computed',
 ...
 */
export function validateCAFormData(formId, data) {
