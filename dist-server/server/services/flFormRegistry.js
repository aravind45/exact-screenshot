...
export const FL1_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    testamentary: {
...
export const FL2_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    smallEstateValue: {
        label: 'Estate Value ($)',
        source: 'computed',
...
export const FL3_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    noticeDate: {
        label: 'Notice Date',
        source: 'computed',
...
export const FL4_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    personalRepresentativeName: {
        label: 'Personal Representative Name',
        source: 'computed',
...
export const FL5_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    personalRepresentativeName: {
        label: 'Personal Representative Name',
        source: 'computed',
...
// FL-6: Inventory
export const FL6_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    inventoryDate: {
...
export const FL7_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    noticeDate: {
        label: 'Notice Date',
        source: 'computed',
...
// FL-8: Proof of Claim
export const FL8_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    creditorName: {
        label: 'Creditor Name',
        source: 'override',
...
export const FL9_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    creditorName: {
        label: 'Creditor Name',
        source: 'override',
...
// FL-10: Accounting
export const FL10_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
...
export const FL11_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
...
export const FL12_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    accountingPeriodStart: {
        label: 'Accounting Period Start',
        source: 'override',
...
export const FL13_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    beneficiaryName: {
...
export const FL14_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    smallEstateValue: {
        label: 'Estate Value ($)',
        source: 'computed',
...
export const FL15_FIELD_REGISTRY = {
    ...FL_HEADER_FIELDS,
    propertyAddress: {
...
export function validateFLFormData(formId, data) {
