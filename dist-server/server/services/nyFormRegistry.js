...
export const ET1_FIELD_REGISTRY = {
    ...NY_HEADER_FIELDS,
    domicileCounty: {
...
export const ET2_FIELD_REGISTRY = {
    ...NY_HEADER_FIELDS,
    domicileCounty: {
        label: 'County of Domicile',
        source: 'estate',
...
export const ET3_FIELD_REGISTRY = {
    ...NY_HEADER_FIELDS,
    foreignWillState: {
...
export const ET8_FIELD_REGISTRY = {
    ...NY_HEADER_FIELDS,
    inventoryDate: {
...
export const ET13_FIELD_REGISTRY = {
    ...NY_HEADER_FIELDS,
    distributionDate: {
...
export function validateNYFormData(formId, data) {
