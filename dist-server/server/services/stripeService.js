...
export class StripeService {
     ...
     */
    static async createBookingPaymentIntent(bookingId, amountDollars, _advisorStripeAccountId) {
        try {
...
StripeService.PLATFORM_FEE_PERCENTAGE = ADVISOR_PLATFORM_FEE_PERCENT; // 20% platform fee
