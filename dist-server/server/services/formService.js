...
export class FormService {
    static async getTemplateBytes(templateName) {
     ...
     */
    static async generateOverlayPdf(templateName, data, mapping) {
     ...
     */
    static async generateCalibrationPdf(templateName) {
...
FormService.TEMPLATES_DIR = path.join(process.cwd(), 'server', 'templates');
